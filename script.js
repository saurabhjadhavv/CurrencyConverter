...
function getExchangeRate() {
    ...
    // enter your own api key in >> https://v6.exchangerate-api.com/v6/your api key/latest/

    let url = `https://v6.exchangerate-api.com/v6/f5c7338c9c6d80469dcd36f4/latest/${fromCurrency.value}`;
